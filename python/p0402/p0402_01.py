...
# #얕은 복사,깊은 복사
# new_list = i_list  #얕은 복사 하나만바꿔도 둘다바뀜
# new_likst2=[*i_list] #깊은 복사  따로 따로임
...
# #딕셔너리 keys,value s
# print(dic.keys())   #  key값출력 
# print(dic.values()) # value값출력
...
# # #딕셔너리 개별출력 
# print(dic['no'])
# # print(dic["kor"]) #키가없는 것을 출력할때 에러 
# print(dic.get('kor')) #get()함수를 사용시 없는 키는 None출력 
